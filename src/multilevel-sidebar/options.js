export const options = [
  ...
  {
    title: "Postprodajne aktivnosti",
    //titleIcon: <i className="fa fa-graduation-cap"></i>,
    content: [
      { id: 1, name: "Arhiviranje dokumentacije", to: "/arhiva" },
      { id: 2, name: "Busiiness Demo Pool", to: "/business-demo-pool" },
      { id: 3, name: "CPA i DOB Blacklist", to: "/cpa" },
      { id: 4, name: "Promena adrese", to: "/promena-adrese" },
    ],
  },
];
